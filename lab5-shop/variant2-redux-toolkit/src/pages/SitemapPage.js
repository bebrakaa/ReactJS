...
function SitemapPage() {
  ...
  return (
    <div className="container">
      <h1>Карта сайта</h1>
      <p className="section-intro">Дополнительная навигация помогает быстро перейти к нужной странице без последовательного обхода меню.</p>
      ...
      <nav aria-label="Карта сайта">
        ...
        {!isAuthenticated ? (
          ...
          <section aria-labelledby="sitemap-account">
            <h2 id="sitemap-account">Разделы авторизованного пользователя</h2>
            <ul>
